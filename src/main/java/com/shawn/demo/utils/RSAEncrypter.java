...
public abstract class RSAEncrypter {
    ...
    private static final Logger LOGGER = Logger.getLogger(RSAEncrypter.class);

    /** 算法名称 */
    private static final String ALGORITHOM = "RSA";
    /**保存生成的密钥对的文件名称。 */
    private static final String RSA_PAIR_FILENAME = "RSA_KEYPAIR";
    /** 密钥大小 */
    ...
    private static synchronized KeyPair generateKeyPair() {
        try {
            keyPairGen.initialize(KEY_SIZE, new SecureRandom(DateFormatUtils.format(new Date(),"yyyyMMdd").getBytes()));//"yyyyMMdd"
    ...
    private static String getRSAPairFilePath() {
        String urlPath = RSAEncrypter.class.getResource("/").getPath();
        LOGGER.debug("urlPath : "+urlPath);
        String filePath = (new File(urlPath).getParent() +File.separator+ RSA_PAIR_FILENAME);
