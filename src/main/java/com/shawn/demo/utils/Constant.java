...
public class Constant {
     ...
     * Dic Manager 
     */
    public static String DICMANAGER_URL ;
    public static String DICMANAGER_USER = "monitorsite";
    public static String DICMANAGER_PWD = "123456" ;
//    public static String TASK_MANAGER_URL = "http://tm.supertool.net.cn:8081/tasks";
//    public static String TASK_MANAGER_CALLBACK_USER = "test";
//    public static String TASK_MANAGER_CALLBACK_PWD = "test";
//    public static String TA_CALLBACK_USER = "test";
//    public static String TA_CALLBACK_PWD = "test";
//    public static String TASK_MANAGER_FINISH_URL = "http://m.mzhen.com:8081/turfCallback.do?method=recalculateSuccessRegister&usr=dGVzdA==&pwd=dGVzdA==&taskId=";
