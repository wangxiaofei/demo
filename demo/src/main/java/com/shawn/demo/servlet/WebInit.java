package com.shawn.demo.servlet;
...
import com.shawn.demo.utils.TemplateConstant;
...
public class WebInit extends HttpServlet {
    ...
    private void initConstant() {
        ...
        // DicManager
        Constant.DICMANAGER_URL = config.getProperty("DICMANAGER_URL");
        Constant.DICMANAGER_USER = config.getProperty("DICMANAGER_USER");
        Constant.DICMANAGER_PWD = config.getProperty("DICMANAGER_PWD");
